...
<?php 
	include_once('event_add.php');?>
             ...
             <?php
			 $date = date("Y-m-d");
			 $sql = "SELECT * FROM tbl_events WHERE event_date>'$date' ORDER BY `event_date` LIMIT 10";
...
$result1 = mysql_fetch_array($sql1);
 ...
 ?>
          		...
          		<table>
                <tr>
                	<td>Going: <a href="Javascript:;" id="<?php echo $row['event_id'] ?>" class="going"><?php echo $num_going;?></a></td>
                      <td>Not Going: <a href="Javascript:;" id="<?php echo $row['event_id'] ?>" class="notgoing"><?php echo $num_not_going; ?></a></td>
                    <td>Thinking:  <a href="Javascript:;" id="<?php echo $row['event_id'] ?>" class="thinking"><?php echo $num_thinking; ?></a></td>
