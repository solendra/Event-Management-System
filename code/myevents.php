...
<?php 
	include_once('event_add.php');?>
			 ...
			 if(isset($_SESSION['user_id']))
			 	{
			 $sql = "SELECT * FROM tbl_events where user_id='$_SESSION[user_id]' ORDER BY event_date";
		...
		?></p>
			...
			<p><?php echo $row['event_time']."&nbsp;"."sharp"?> </p>
			 ...
			 if($_SESSION['user_id']==$row['user_id'])
			 	{
				//$res = mysql_fetch_array(mysql_query("SELECT * FROM tbl_events WHERE user_id = '$row[user_id]'"));
			 ?>   
...
$result1 = mysql_fetch_array($sql1);
 ...
 <?php }?>
	    ...
	    <a id="lnk_going" href="myparticipation.php?attend=1&user_id=<?php echo $_SESSION['user_id']; ?>&event_id=<?php echo $row['event_id'];		          ?>">
                    Going</a>
          
	  <a id="lnk_notgoing" href="myparticipation.php?attend=2&user_id=<?php echo $_SESSION['user_id'];?>&event_id=<?php echo $row['event_id'];?>">
       Not Going</a>
	     
      <a id="lnk_thinking" href="myparticipation.php?attend=3&user_id=<?php echo $_SESSION['user_id']; ?>&event_id=<?php echo $row['event_id'];?>">
